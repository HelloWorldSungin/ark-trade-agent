...
| Outcome scorer | [outcome-scorer-config.md](vault/Operations/outcome-scorer-config.md) | 2 of 7 metrics live (`next_day_direction` + `risk_rule_compliance`); 5 metrics queued (incl. `rationale_trade_match` wired in code, blessing pending) |
